...
def get_form_authorization(request, *args, **kwargs):
		...
		# { "template_name": 'users/authorization.html', "context": context }
		
		return render( request, template_name = 'users/authorization.html', context = context )
